...
export const resumeData = {
  ...
  projects: [
    ...
    },
    {
      id: "scheduling",
      name: "團隊排班系統",
      desc: "自動化排班解決方案。整合 React 與 Firebase 後端，開發過程中利用 AI 快速迭代複雜的邏輯算法。本人負責資料庫結構設計與 AI 代碼的整合測試，有效縮短開發週期並保持邏輯嚴密。",
    ...
    },
    {
      id: "xiaobei-log",
      name: "小北百貨建工店",
      desc: "門市營運記錄系統。運用 AI 輔助處理前端視覺佈局與響應式開發，本人透過 Chrome DevTools 進行即時除錯與動線優化，實現高效的資訊呈現與視覺陳列記錄。",
